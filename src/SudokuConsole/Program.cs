...
namespace SudokuConsole
{
    ...
    internal class Program
    {
        ...
        private static Solver CreateSolver() => new Solver()
            .WithTechnique(new SingleCandidateInCell())
            .WithTechnique(new OneNumberPerRow())
            .WithTechnique(new OneNumberPerColumn())
            .WithTechnique(new OneNumberPerBox())
            .WithTechnique(CellsForCandidates.OnePerRow())
            .WithTechnique(CellsForCandidates.OnePerColumn())
            .WithTechnique(CellsForCandidates.OnePerBox())
            .WithTechnique(new BoxCandidatesInSingleRow())
            .WithTechnique(new BoxCandidatesInSingleColumn())
            .WithTechnique(new RowCandidatesInSingleBox())
            .WithTechnique(new ColumnCandidatesInSingleBox())
            .WithTechnique(CellsForCandidates.TwoPerRow())
            .WithTechnique(CellsForCandidates.TwoPerColumn())
            .WithTechnique(CellsForCandidates.TwoPerBox())
            .WithTechnique(CellsWithSameCandidatesInCollection.TwoPerRow())
            .WithTechnique(CellsWithSameCandidatesInCollection.TwoPerColumn())
            .WithTechnique(CellsWithSameCandidatesInCollection.TwoPerBox())
            .WithTechnique(CellsForCandidates.ThreePerRow())
            .WithTechnique(CellsForCandidates.ThreePerColumn())
            .WithTechnique(CellsForCandidates.ThreePerBox())
            .WithTechnique(CellsWithSameCandidatesInCollection.ThreePerRow())
            .WithTechnique(CellsWithSameCandidatesInCollection.ThreePerColumn())
            .WithTechnique(CellsWithSameCandidatesInCollection.ThreePerBox())
            .WithTechnique(CellsForCandidates.FourPerRow())
            .WithTechnique(CellsForCandidates.FourPerColumn())
            .WithTechnique(CellsForCandidates.FourPerBox())
            .WithTechnique(CellsWithSameCandidatesInCollection.FourPerRow())
            .WithTechnique(CellsWithSameCandidatesInCollection.FourPerColumn())
            .WithTechnique(CellsWithSameCandidatesInCollection.FourPerBox())
            .WithTechnique(FishTechnique.TwoRow())
            .WithTechnique(FishTechnique.TwoColumn())
            .WithTechnique(new XyWingTechnique())
            .WithTechnique(FishTechnique.ThreeRow())
            .WithTechnique(FishTechnique.ThreeColumn())
            .WithTechnique(FishTechnique.FourRow())
            .WithTechnique(FishTechnique.FourColumn());
